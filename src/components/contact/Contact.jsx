...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ok611pl', 'template_eypwnha', form.current, 'RBqxmbfXccG60eG3s')
      e.target.reset()
  };
  return (
        ...
        <div className="contact_content">
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">gangshyer@gmail.com</span>

              <a href="https://mail.google.com/" className="contact_button">
                Write me {" "}
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">+977 9868253904</span>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">Gangshyer Dorjee Tamang</span>

              <a href="https://www.linkedin.com/in/gangshyer-dorjee-tamang-85403124a/" className="contact_button">
                Write me {" "}
                <i className="bx bx-right-arrow-alt conatct_button-icon"></i>
              </a>
            </div>
